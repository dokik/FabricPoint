...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified captureView;
@property (nonatomic, strong) AVCaptureVideoPreviewLayer * _Null_unspecified previewLayer;
@property (nonatomic, strong) UIView * _Null_unspecified highlightView;
...
@property (nonatomic, copy) NSIndexPath * _Nonnull select_user;
...
- (IBAction)pushGetPoint:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11FabricPoint21WaitingViewController")
@interface WaitingViewController : UIViewController
@property (nonatomic, copy) void (^ _Nullable waitingViewDidAppearHandler)(WaitingViewController * _Nonnull);
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified messageView;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (void)dismissViewControllerAnimatedAsyncWithAnimated:(BOOL)animated completion:(void (^ _Nullable)(void))completion;
@end
